let initVar = {
  ...
  meta: {},
  vapidKey: "BIbLN71IxHkh1YKVSzMM7R7U-tYxb5ReTqiXzVg_uWUHbinxiWR1VB5d-sOP456oOV8OYaT0Ezv0Fe7Se8IMd6E",
  clientId: "V9WRRUCVGTJ4A3861LKDSKLL",
  pushOptInSetting: {"delay":86400,"message":{"body":"We will notify you about new products and exclusive promotions","title":"Never miss a sale","buttons":[{"label":"Later","order":1},{"label":"Allow","order":2}],"iconUrl":"https://cdn.shopify.com/s/files/1/0047/6708/8675/t/11/assets/grow-LPK1KN2N1QNKMEPPGIF6EY55.png"},"isEnabled":true,"showModal":true,"initialDelay":60},
  subscriberId: '',
  stockFulFilledPushCampaign: {
    isActive: false,
    uniqueId: '83VJLHC1Z1BVYQJZ4AMJRJI2'
  },
  stockFulFilledEmailCampaign: {
    isActive: true,
    uniqueId: '8PR4F2DTDPEW5VCUIJNHZHF4'
  },
  stockFulFilledSmsCampaign: {
    isActive: false,
    uniqueId: 'KSSIKMLJKIP6W4AJSEY1NX48'
  },
  priceDropPushCampaign: {
    isActive: false,
    uniqueId: 'DQ4UQ5S5LXWQ5N18CCNCG2PW',
  },
  priceDropEmailCampaign: {
    isActive: false,
    uniqueId: 'RXMHWMCFSKNUAX89VI6L6GQL',
  },
  priceDropSmsCampaign: {
    isActive: false,
    uniqueId: 'ZKZUBP25N4VJLQY9HS69LGQA',
  },
  stockWidget: {
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <h3 class="modal-title">Item out of stock?</h3>
    <p class="notification-message">We will notify you if it comes back!</p>
    ...
    new Vue({
      ...
      data: () => {
        return {
          ...
          heading: "heading",
          subheading: "We will notify you if it comes back!",
          notifyButtonTitle: "Notify Me",
          privacyText: "We respect your privacy and do not share your email with anyone.",
          emailWorkflowUniqueId: "8PR4F2DTDPEW5VCUIJNHZHF4",
          smsWorkflowUniqueId: "KSSIKMLJKIP6W4AJSEY1NX48",
    ...
    new Vue({
      ...
      data: () => {
        return {
          ...
          notifyButtonTitle: "Notify Me",
          privacyText: "We respect your privacy and do not share your email with anyone.",
          emailWorkflowUniqueId: "RXMHWMCFSKNUAX89VI6L6GQL",
          smsWorkflowUniqueId: "ZKZUBP25N4VJLQY9HS69LGQA",
          successText: "Your notification has been registered.",
          successCloseText: "Close",
          optInMarketingText: "Signup for newsletter?",
          email: "",
...
if(document.querySelectorAll("input[disabled][data-index] "))
[...document.querySelectorAll("input[disabled][data-index]")].map(x=>x.removeAttribute("disabled"));`,
  customCss: `null`,
  ...
  getProduct: async function () {
    ...
    if (!window.product || window.product.id !== product.id || !window.product.variants || !window.product.length) {
      let product;
      try {
        product = (await (await fetch(`${window.location.href.split("?")[0].split("#")[0]}.js`)).json())
      } catch (e) {
  ...
  renderStockWidget: async function (product, variant) {
    ...
    if (!initVar.checkIfInStock(variant)) {
  ...
  checkIfInStock: function (variant) {
...
`
  ...
  if (initVar.customCss) {
    let scriptElm = document.createElement('style');
    scriptElm.innerText = initVar.customCss
    document.head.appendChild(scriptElm)
  }
  lastPage = null;
